...
function showResult(){
    ...
    if (userScore > 7){
        let scoreTag = '<span> Felicidades! 🎉, Conseguiste <p>'+ userScore +'</p> de <p>'+ selectedQuestions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else if(userScore > 4){
        let scoreTag = '<span> Bien 😎, Conseguiste <p>'+ userScore +'</p> de  <p>'+ selectedQuestions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else if(userScore > 0){
        let scoreTag = '<span> Hay que estudiar 😅, Conseguiste <p>'+ userScore +'</p> de  <p>'+ selectedQuestions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span> Lo siento 😞, Conseguiste  <p>'+ userScore +'</p> de  <p>'+ selectedQuestions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
